...
session_start();
include "db_conn.php";
if (isset($_POST['uname']) && isset($_POST['pass']) && isset($_POST['name']) && isset($_POST['re_pass'])) {
    ...
    if (empty($uname)) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if($result2) {
                header("Location: signup.php?successs=Your account has been created successfully");
                exit();
            }else{
